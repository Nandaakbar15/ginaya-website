    ...
    <section className="mx-auto max-w-2xl pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8 -mb-24">
      ...
      <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        ...
        <div className="relative group mx-auto">
          ...
          <Link
            href={"https://www.instagram.com/ginaya_archint/"}
            target="_blank"
          >
            <button className="hidden absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-semibold group-hover:block">
              <Image
